...
pcb_t *         check(pcb_t * parent, const char *tag, pcb_t * o)
      ...
      while((o=pcb_find(pcb,"gr_rect",o)))
      {
	      ...
	      double sx=0,sy=0,ex=0,ey=0;
		       ...
		       continue;
               if (!(o2 = pcb_find (o, "stroke", NULL)) || !(o2=pcb_find(o2,"width",NULL))||o2->valuen!=1||!o2->values[0].isnum || o2->values[0].num)
		       continue;
               if (!(o2 = pcb_find (o, "layer", NULL)) || o2->valuen!=1||!o2->values[0].istxt || !strstr(o2->values[0].txt,"SilkS"))
		       continue;
